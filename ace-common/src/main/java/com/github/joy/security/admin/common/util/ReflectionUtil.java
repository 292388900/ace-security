...
public class ReflectionUtil
{
    ...
    /**
     * 直接读取对象属性值，无论private/protected修饰符，不经过getter函数
     * 
     * @param obj
     * @param fieldName
     * @return
    ...
    public static void setFieldValue(final Object obj, final String fieldName, final Object value){
        ...
        if(field == null){
            logger.error("Could not find field [{}] on target [{}]", fieldName, obj);
            return;
        }
    ...
    /**
     * 循环向上转型，获取对象的DeclaredMethod，并强制设置为可访问 如向上转型到Object仍无法找到，返回null 匹配函数名+参数模型
     * 
    ...
    /**
     * 循环向上转型，获取对象的DeclareMethod，并强制设置为可访问 如向上转型为Object仍无法找到，返回null 只匹配函数名
     * 
     * 用于方法需要多次调用的情况，先使用本函数取得Method，然后调用Method.invoke(Object obj, Object... args)
     * 
     * @param obj
     * @param methodName
     * @return
    ...
    /**
     * 将反射的checked exception转换为unchecked exception
     * 
     * @param e
     * @return
     * @see [类、类#方法、类#成员]
